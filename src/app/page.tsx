    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 shadow-2xl border-b border-slate-700/50 p-6 relative z-10 flex flex-col items-center">
        <div className="flex items-center justify-center gap-4 mb-2">
          <img src="https://upload.wikimedia.org/wikipedia/en/thumb/5/5f/Amity_University_logo.png/220px-Amity_University_logo.png" alt="Amity Logo" className="h-16 w-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]" />
